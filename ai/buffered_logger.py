...
class BufferedLogger:
    ...
    def log(self, level: int, message: str, *args, **kwargs) -> None:
        ...
        formatted_message = self._logger._log.format(self._logger, level, message, args, **kwargs)
    ...
    def flush(self) -> None:
        ...
        try:
            ...
            if self._logger is not None:
                self._logger.error(f"Ошибка при сбросе буферизованного логгера: {e}", exc_info=True)

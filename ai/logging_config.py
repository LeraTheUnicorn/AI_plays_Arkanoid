...
# ✅ ИЗМЕНЕНО: По умолчанию 'INFO' для уменьшения частоты логирования и предотвращения фризов
# Для отладки можно изменить на 'DEBUG', но это может вызывать фризы при высокой скорости мяча

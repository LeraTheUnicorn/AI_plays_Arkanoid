...
class TestAIPlayerTargetCalculationMixin:
    ...
    def _create_mock_player(self):
        ...
        player.position_calculator.calculate_precise_position_for_few_bricks = Mock(return_value=None)
        player.position_calculator.calculate_position_for_max_destruction = Mock(return_value=None)
        player.position_calculator.calculate_position_with_target_brick = Mock(return_value=None)
    ...
    def test_calculate_target_position_no_game_state(self):
        ...
        result = player._calculate_target_position(400.0, 400.0, {
    ...
    def test_calculate_target_position_precision_priority(self):
        ...
        player.position_calculator.calculate_precise_position_for_few_bricks.return_value = 450
    ...
    def test_calculate_position_with_target_brick(self):
        ...
        player.position_calculator.calculate_position_with_target_brick.return_value = 450
    ...
    def test_ensure_safe_paddle_position_left_edge(self):
        ...
        assert result >= paddle_center_x  # Должно сместиться вправо или остаться на месте
    ...
    def test_ensure_safe_paddle_position_right_edge(self):
        ...
        landing_x = 750.0  # Очень близко к правому краю платформы (paddle_right_edge = 760)
        
        result = player._ensure_safe_paddle_position(paddle_center_x, landing_x)
        
        assert result <= paddle_center_x  # Должно сместиться влево или остаться на месте
        assert isinstance(result, float)

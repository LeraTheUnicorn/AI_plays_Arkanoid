...
from ai.ai_player_position_optimization_part2 import (
...
class TestAIPlayerPositionOptimizationPart2Mixin:
    ...
    def test_find_best_target_for_few_bricks_multiple_bricks(self):
        ...
        result = player._find_best_target_for_few_bricks(
            [mock_brick1, mock_brick2], 550, 400
        )
    ...
    def test_calculate_optimal_offset_with_velocity(self):
        ...
        player.current_game_state = GameState(
            ...
            paddle_width=120,
            remaining_bricks=[Mock()]
            * 2,  # Не 1 кирпич, чтобы не использовать специальную логику
            game_score=0,
            game_time=0,
            ball_speed=5,
        )

...
class TestLearningSystem:
    ...
    def test_update_strategy_success(self):
        ...
        with patch("ai.learning_system.get_ai_directory") as mock_dir, patch.object(
            LearningSystem, "save_model"
        ) as mock_save:
            mock_dir.return_value = tempfile.gettempdir()
    ...
    def test_determine_strategy_type_aggressive(self):
        ...
        with patch("ai.learning_system.get_ai_directory") as mock_dir:
            ...
            action_result = {"movement_distance": 60, "time_taken": 0.05}
    ...
    def test_determine_strategy_type_precision(self):
        ...
        with patch("ai.learning_system.get_ai_directory") as mock_dir:
            ...
            action_result = {"movement_distance": 5, "time_taken": 0.1}
    ...
    def test_determine_strategy_type_conservative(self):
        ...
        with patch("ai.learning_system.get_ai_directory") as mock_dir:
            ...
            action_result = {"movement_distance": 25, "time_taken": 0.1}
    ...
    def test_load_model(self):
        ...
        try:
            with patch("ai.learning_system.get_ai_directory") as mock_dir:
                ...
                assert (
                    system.learning_data.get("strategy_weights", {}).get("aggressive")
                    == 0.7
                )
        finally:
            if os.path.exists(model_path):
